...
ENABLE_SUPPORT_AGENT=${ENABLE_SUPPORT_AGENT:-true}
...
# Conditionally add SUPPORT_ENGINE_ID to required variables
if [[ "${ENABLE_SUPPORT_AGENT}" == "true" ]]; then
  REQUIRED_VARS+=("SUPPORT_ENGINE_ID")
fi
...
ENV_VARS+="ENABLE_SUPPORT_AGENT=${ENABLE_SUPPORT_AGENT},"
...
ENV_VARS+="SUPPORT_URL_ORDER_SUPPORT=${SUPPORT_URL_ORDER_SUPPORT:-/orders},"
ENV_VARS+="SUPPORT_URL_DEALS_AND_COUPONS=${SUPPORT_URL_DEALS_AND_COUPONS:-/promotions},"
ENV_VARS+="SUPPORT_URL_STORE_RELEVANT=${SUPPORT_URL_STORE_RELEVANT:-/stores},"
ENV_VARS+="SUPPORT_URL_RETAIL_SUPPORT=${SUPPORT_URL_RETAIL_SUPPORT:-/support},"
ENV_VARS+="GECX_LOCATION=${GECX_LOCATION},"
ENV_VARS+="GECX_PROJECT_ID=${GECX_PROJECT_ID},"
ENV_VARS+="GECX_AGENT_ID=${GECX_AGENT_ID}"
